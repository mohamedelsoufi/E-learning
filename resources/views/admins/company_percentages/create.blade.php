...
@section('title', "add countries percentage")
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li> <a href="#"><i class="fa fa-users"></i>countries percentage</a></li>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control  @error('percentage') is-invalid @enderror" name="percentage"
