                            ...
                            <div class="form-group">
                                ...
                                <select name="year_id" class="form-control">
                                    @foreach ($years as $year)
                                        <option value="{{$year->id}}" @if ($year_cost->year_id == $year->id) selected @endif>{{$year->Level->Curriculum->translate('en')->name}} => {{$year->Level->translate('en')->name}} => {{$year->translate('en')->name}}</option>
                                    @endforeach
                                </select>
                                @error('year_id')
                                    <small class=" text text-danger" role="alert">
