    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li> <a href="#"><i class="fa fa-users"></i>materials
                </a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('name') is-invalid @enderror" name="materials[{{$localeCode}}][name]"
                                        placeholder="name" value="{{$material->translate($localeCode)->name}}" required autocomplete="off">
                                    @error('name')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="checkbox" id="switcherySize" value="1" class="switchery" name="status" data-size="lg" @if ($material->status == 1) checked @endif/>
