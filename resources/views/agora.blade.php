...
<head>
  ...
  <link rel="stylesheet" href="{{url('/public/agora/vendor/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{url('/public/agora/index.css')}}">
</head>
<body>
    ...
    <form id="join-form">
      <div class="row join-info-group">
          <div class="col-sm">
            ...
            <input id="appid" value="{{env('AGORA_APP_ID')}}"  type="text" placeholder="enter appid" required>
          ...
          <div class="col-sm">
            ...
            <input id="token" type="text" value="{{$token}}" placeholder="enter token">
          ...
          <div class="col-sm">
            ...
            <input id="channel" value="{{$chennel}}" type="text" placeholder="enter channel name" required>
  ...
  <script src="{{url('/public/agora/vendor/jquery-3.4.1.min.js')}}"></script>
  <script src="{{url('/public/agora/vendor/bootstrap.bundle.min.js')}}"></script>
  <script src="{{url('/public/agora/AgoraRTC_N-4.11.0.js')}}"></script>
  <script src="{{url('/public/agora/index.js')}}"></script>
</body>
</html>
